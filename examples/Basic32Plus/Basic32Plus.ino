/*
DyanHTML Basic Plus OTA test for ESP32.
...
Changed a few setting to work with ESP32 Libraries
*/
...
const char *ssidAP = "ESP32_DynaHTML";
...
void setup()
{
    ...
    pinMode(LED_CONFIG, OUTPUT);  // Initialize the BUILTIN_LED pin as an output
